...
export default function Encryption() {
  return (
    <div className='flex flex-col relative items-center justify-center w-full mt-[-130px] md:mt-[-120px] h-200px md:min-h-[50vh]'>
        <div className='absolute w-auto h-auto -top-[190px] md:-top-[130px] z-[5]'>
            <motion.div
                className=' px-4 text-4xl md:text-[40px] font-medium text-center text-gray-200'>
                    Performance 
