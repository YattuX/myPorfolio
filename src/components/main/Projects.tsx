...
export default function Projects() {
  return (
    <div id='projects' className='flex flex-col items-center justify-center py-20 mt-10 mx-4'>
        ...
        <div className='h-full w-full flex flex-col md:flex-row gap-10 px-5 mt-[-40px]'>
            <ProjectCard
                src="/alphax.PNG"
